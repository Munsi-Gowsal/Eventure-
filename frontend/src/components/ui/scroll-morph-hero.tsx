            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    ...
                    <motion.p
                        ...
                        className="mt-4 text-xs font-bold tracking-[0.2em] text-[var(--color-accent-primary)]"
                    >
                ...
                >
                    ...
                    <p className="text-sm md:text-lg text-gray-400 max-w-2xl leading-relaxed mx-auto">
                        Your premium destination for tech conferences, art shows, and underground music. <br className="hidden md:block" />
                        Scroll down to immerse yourself in experiences.
                    </p>
                </motion.div>
